            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="course.courseDate.label" default="Course Date" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${courseInstance?.courseDate}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="course.minStudents.label" default="Min Students" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: courseInstance, field: "minStudents")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="course.maxStudents.label" default="Max Students" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: courseInstance, field: "maxStudents")}</td>
